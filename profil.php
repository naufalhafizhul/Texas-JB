		...
		<div class="container">
			...
			<div class="box">
				<form action="" method="POST">
					...
					<input type="submit" name="submit" value="Ubah Profil" class="tmbh-btn" style="margin-top: 0;">
				</form>
				<?php 
			...
			<div class="box">
				<form action="" method="POST">
					...
					<input type="submit" name="ubah_password" value="Ubah Password" class="tmbh-btn" style="margin-top: 0;">
				</form>
				<?php 
